...
| `axi_pkg_tb` | `test_axi_write_drives_address_and_data` | :white_check_mark: Pass | 0.6s |
| `tb_pkg_tb` | `test_debug_mode_toggle` | :white_check_mark: Pass | 0.2s |
...
| `tb_pkg_tb` | `test_scale_real_to_slv_clamps_out_of_range_input` | :white_check_mark: Pass | 1.0s |
...
| `tb_pkg_tb` | `test_vec2string_bit_order` | :white_check_mark: Pass | 0.6s |
| `uart_tb` | `test_uart_rx_receives_byte_cd` | :white_check_mark: Pass | 0.4s |
...
| `uart_tb` | `test_uart_tx_rx_loopback` | :white_check_mark: Pass | 0.5s |
