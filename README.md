...
[![Tests](https://img.shields.io/badge/tests-28%20passed-brightgreen)](#test-results)
...
| `tb_pkg_tb` | 18 | 18 | 0 | :white_check_mark: Pass | NVC |
| `uart_tb` | 8 | 8 | 0 | :white_check_mark: Pass | NVC |

<details>
<summary><b>Detailed Test Cases (28 passed, 0 failed)</b></summary>
...
| `tb_pkg_tb` | `test_format_hex` | :white_check_mark: Pass | 0.2s |
| `tb_pkg_tb` | `test_get_wait_cycles` | :white_check_mark: Pass | 0.3s |
| `tb_pkg_tb` | `test_my_is_equal_pass_path` | :white_check_mark: Pass | 0.2s |
| `tb_pkg_tb` | `test_pulse_reset` | :white_check_mark: Pass | 0.2s |
| `tb_pkg_tb` | `test_push_stream` | :white_check_mark: Pass | 0.2s |
...
| `tb_pkg_tb` | `test_wait_cycles` | :white_check_mark: Pass | 0.2s |
